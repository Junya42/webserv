...
return_button = "<a href = \"http://webserv.42.com:65535/cgi-bin/get.sh/user\" target=\"_self\" class=\"glass-button-return\"> Return</a>\n"
...
if exist == 1:
    ...
    for val in listing:
        ...
        if isdir == 1:
            x += "<a href=\"http://webserv.42.com:65535/cgi-bin/delete_webserv.py" + path + val + "\" target=\"_self\" class=\"glass-button-folder\">" + val + "</a>\n"
        else:
            y += "<a href=\"http://webserv.42.com:65535" + path + val + "\" data-method=\"delete\" class=\"glass-button\">" +"Delete " + val + "</a>\n"
